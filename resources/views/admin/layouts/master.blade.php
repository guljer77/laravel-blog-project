    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
              ...
              <span class="app-brand-logo demo">
                <svg
                  ...
                  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="app-brand-text demo menu-text fw-bold ms-2 text-uppercase">Blog</span>
                </a>
            ...
            <ul class="menu-inner py-1">
                ...
                <!-- Components -->
                <li class="menu-header small text-uppercase"><span class="menu-header-text">Tags</span></li>
                <!-- Cards -->
                <!-- User interface -->
                <li class="menu-item">
                    <a href="javascript:void(0)" class="menu-link menu-toggle">
                        <i class="menu-icon tf-icons bx bx-cube-alt"></i>
                        <div data-i18n="User interface">Tag</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        <i class="menu-icon tf-icons bx bx-cube-alt"></i>
                        <div data-i18n="Form Elements">Post</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
